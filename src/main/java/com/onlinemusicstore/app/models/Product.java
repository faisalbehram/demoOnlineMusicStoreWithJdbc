...
public class Product {
	...
	public Product(String productId, @NotNull(message = "The product name must not be null.") String productName,
			String productCategory, String productDescription, String productCondition, String productStatus,
